...
namespace LottoStuff
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            NumberGenerator numberGenerator = new NumberGenerator(6, 60);
            Console.WriteLine(numberGenerator.numberCollection.Count);
            //NumberRemoval numberRemoval = new NumberRemoval(5, 70);
